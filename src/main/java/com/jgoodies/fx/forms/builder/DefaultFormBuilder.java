...
import com.jgoodies.fx.forms.factories.FormFactory;
import com.jgoodies.fx.forms.layout.ConstantSize;
import com.jgoodies.fx.forms.layout.FormLayoutPane;
import com.jgoodies.fx.forms.layout.RowSpec;

import javafx.scene.Node;
import javafx.scene.control.Label;

/**
 * Provides a means to build form-oriented panels quickly and consistently using the {@link FormLayout}. This
 * builder combines frequently used panel building steps: add a new row, add a label, proceed to the next data
 * column, then add a component.
 * <p>
 * The extra value lies in the <code>#append</code> methods that append gap rows and component rows if
 * necessary and then add the given components. They are built upon the superclass behavior
 * <code>#appendRow</code> and the set of <code>#add</code> methods. A set of component appenders allows to
 * add a textual label and associated component in a single step.
 * <p>
 * This builder can map resource keys to internationalized (i15d) texts when creating text labels, titles and
 * titled separators. Therefore you must specify a <code>ResourceBundle</code> in the constructor. The builder
 * methods throw an <code>IllegalStateException</code> if one of the mapping builder methods is invoked and no
 * bundle has been set.
 * <p>
 * You can configure the build process by setting a leading column, enabling the row grouping and by modifying
 * the gaps between normal lines and between paragraphs. The leading column will be honored if the cursor
 * proceeds to the next row. All appended components start in the specified lead column, except appended
 * separators that span all columns.
 * <p>
 * It is temptive to use the DefaultFormBuilder all the time and to let it add rows automatically. Use a
 * simpler style if it increases the code readability. Explicit row specifications and cell constraints make
 * your layout easier to understand - but harder to maintain. See also the accompanying tutorial sources and
 * the Tips &amp; Tricks that are part of the Forms documentation.
 * <p>
 * Sometimes a form consists of many standardized rows but has a few rows that require a customization. The
 * DefaultFormBuilder can do everything that the superclasses
 * {@link com.jgoodies.forms.builder.AbstractFormBuilder} and {@link com.jgoodies.forms.builder.PanelBuilder}
 * can do; among other things: appending new rows and moving the cursor. Again, ask yourself if the
 * DefaultFormBuilder is the appropriate builder. As a rule of thumb you should have more components than
 * builder commands. There are different ways to add custom rows. Find below example code that presents and
 * compares the pros and cons of three approaches.
 * <p>
 * The texts used in methods <code>#append(String, ...)</code> and <code>#appendTitle(String)</code> as well
 * as the localized texts used in methods <code>#appendI15d</code> and <code>#appendI15dTitle</code> can
 ...
 * </pre>
 * <p>
 * TODO: Consider adding a method for appending a component that spans the remaining columns in the current
 * row. Method name candidates are <code>#appendFullSpan</code> and <code>#appendRemaining</code>.
 *
...
public final class DefaultFormBuilder extends I15dPanelBuilder
{
    ...
    /**
     * Holds the row specification that is reused to describe rows that are intended for labels and
     * components.
     *
     ...
     */
    public DefaultFormBuilder( FormLayoutPane layout )
    {
        this( layout, null );
    }

    /**
     * Constructs a <code>DefaultFormBuilder</code> for the given layout and resource bundle.
     *
     * @param layout
     *            the <code>FormLayout</code> to be used
     * @param bundle
     ...
     */
    public DefaultFormBuilder( FormLayoutPane layout, ResourceBundle bundle )
    {
        super( layout, bundle );
    }
     ...
     *
     * @param lineGapSize
     *            the <code>ConstantSize</code> that describes the size of the gaps between component lines
     */
     ...
     *            the <code>ConstantSize</code> that describes the size of the gaps between paragraphs
     */
    ...
    /**
     * Adds a component to the panel using the default constraints with a column span of 1. Then proceeds to
     * the next data column.
     *
     * @param component
     *            the component to add
     */
    public void append( Node component )
    {
        append( component, 1 );
    }

    /**
     * Adds a component to the panel using the default constraints with the given columnSpan. Proceeds to the
     * next data column.
     *
     * @param component
     ...
     */
    public void append( Node component, int columnSpan )
    {
    ...
    /**
     * Adds two components to the panel; each component will span a single data column. Proceeds to the next
     * data column.
     *
     * @param c1
     ...
     */
    public void append( Node c1, Node c2 )
    {
        append( c1 );
        append( c2 );
    }
    ...
    /**
     * Adds three components to the panel; each component will span a single data column. Proceeds to the next
     * data column.
     *
     * @param c1
     *            the first component to add
     ...
     */
    public void append( Node c1, Node c2, Node c3 )
    {
        append( c1 );
        append( c2 );
        append( c3 );
     ...
     * <p>
     * The created label is labeling the given component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     *
     * @param textWithMnemonic
     *            the label's text - may mark a mnemonic
     * @param component
     ...
     * @return the added label
     */
    public Label append( String textWithMnemonic, Node component )
    {
     ...
     */
    public Label append( String textWithMnemonic, Node c, boolean nextLine )
    {
     ...
     * @see JLabel#setLabelFor(java.awt.Component)
     */
    public Label append( String textWithMnemonic, Node c, int columnSpan )
    {
    ...
    /**
     * Adds a text label and two components to the panel; each component will span a single column. Proceeds
     * to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     *
     * @param textWithMnemonic
     *            the label's text - may mark a mnemonic
     ...
     * @return the added label
     */
    public Label append( String textWithMnemonic, Node c1, Node c2 )
    {
     ...
     */
    public Label append( String textWithMnemonic, Node c1, Node c2, int colSpan )
    {
        Label label = append( textWithMnemonic, c1 );
        append( c2, colSpan );
        return label;
    ...
    /**
     * Adds a text label and three components to the panel; each component will span a single column. Proceeds
     * to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     ...
     * @return the added label
     */
    public Label append( String textWithMnemonic, Node c1, Node c2, Node c3 )
    {
    ...
    /**
     * Adds a text label and four components to the panel; each component will span a single column. Proceeds
     * to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     ...
     * @return the added label
     */
    public Label append( String textWithMnemonic, Node c1, Node c2, Node c3, Node c4 )
    {
    ...
    /**
     * Adds an internationalized (i15d) text label to the panel using the given resource key and proceeds to
     * the next column.
     *
     * @param resourceKey
    ...
    /**
     * Adds an internationalized (i15d) text label and component to the panel. Then proceeds to the next data
     * column.
     * <p>
     * The created label is labeling the given component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node component )
    {
    ...
    /**
     * Adds an internationalized (i15d) text label and component to the panel. Then proceeds to the next data
     * column. Goes to the next line if the boolean flag is set.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     *
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node component, boolean nextLine )
    {
        return append( getI15dString( resourceKey ), component, nextLine );
    }

    /**
     * Adds an internationalized (i15d) text label to the panel using the given resource key; then proceeds to
     * the next data column and adds a component with the given column span. Proceeds to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     *
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node c, int columnSpan )
    {
        return append( getI15dString( resourceKey ), c, columnSpan );
    }

    /**
     * Adds an internationalized (i15d) text label and two components to the panel; each component will span a
     * single column. Proceeds to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     *
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node c1, Node c2 )
    {
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node c1, Node c2, int colSpan )
    {
        return append( getI15dString( resourceKey ), c1, c2, colSpan );
    }

    /**
     * Adds an internationalized (i15d) text label and three components to the panel; each component will span
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node c1, Node c2, Node c3 )
    {
        return append( getI15dString( resourceKey ), c1, c2, c3 );
    }

    /**
     * Adds an internationalized (i15d) text label and four components to the panel; each component will span
     * a single column. Proceeds to the next data column.
     * <p>
     * The created label is labeling the first component; so the component gets the focus if the (optional)
     * label mnemonic is pressed.
     ...
     * @return the added label
     */
    public Label appendI15d( String resourceKey, Node c1, Node c2, Node c3, Node c4 )
    {
     ...
     * @return the added titled separator
     */
    public Node appendSeparator( String text )
    {
        ensureCursorColumnInGrid();
        ...
        Node titledSeparator = addSeparator( text );
        setColumnSpan( 1 );
     ...
     * @return the added titled separator
     */
    public Node appendI15dSeparator( String resourceKey )
    {
    ...
    /**
     * Ensures that the cursor is in the grid. In case it's beyond the form's right hand side, the cursor is
     * moved to the leading column of the next line.
     */
    ...
    /**
     * Ensures that the form has a component row. Adds a component row if the cursor is beyond the form's
     * bottom.
     */
    private void ensureHasComponentLine()
    {
        ...
        {
            getLayoutPane().addGroupedRow( getRow() );
        }
    }
    ...
    {
        return getLayoutPane().getRowSpec( getRow() );
    }
